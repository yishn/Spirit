...
class Dispatcher {
    # config settings
    public static function config($name, $info = null) {

        $data = &self::$globals['config'];
    ...
    public static function stash($name = null, $value = null) {

        $data = &self::$globals['stash'];
        $argc = func_num_args();
    ...
    public static function headers() {
        ...
        $headers = &self::$globals['request_headers'];
        ...
        # error case
        if ($argc < 1) {
            throw new BadpublicFunctionCallException(
    ...
    public static function attachments($name) {
    ...
    public static function input($load = false, $pipe = 'php://input') {
    ...
    public static function redirect($path, $code = 302, $halt = false) {
    ...
    public static function hook($name, $func) {
        self::$globals['routes']['hooks'][$name] = $func;
    }
